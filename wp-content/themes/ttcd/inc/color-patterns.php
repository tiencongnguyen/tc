 ...
 */
function ttcd_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Ttcd default saturation level.
	 *
	 * @since Ttcd 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'ttcd_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ttcd-front-page) .entry-title,
...
.colors-custom .ttcd-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ttcd-front-page .panel-content .recent-posts article,
...
.colors-custom.ttcd-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Ttcd custom colors CSS.
	 *
	 * @since Ttcd 1.0
	 *
	 ...
	 */
	return apply_filters( 'ttcd_custom_colors_css', $css, $hue, $saturation );
}
